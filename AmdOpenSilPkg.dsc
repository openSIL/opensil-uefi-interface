...
[Defines]
  ...
  SIL_PROG_NAME                  = $(AMD_PROCESSOR)
!if $(PROCESSOR_PATH) == "TurinOpenSilBoard"
  SIL_PROG_NAME                  = TurinOpenSil
!endif
...
[Components.IA32]
  ...
  AmdOpenSilPkg/opensil-uefi-interface/Platform/$(SIL_PROG_NAME)/Pei/Sil$(SIL_PROG_NAME)Pei.inf {
    <LibraryClasses>
    AmdBaseLib|AgesaModulePkg/Library/AmdBaseLib/AmdBaseLibNoIntrinsic.inf
  }

[Components.X64]
  AmdOpenSilPkg/opensil-uefi-interface/Platform/$(SIL_PROG_NAME)/Dxe/Sil$(SIL_PROG_NAME)Dxe.inf
  AmdOpenSilPkg/opensil-uefi-interface/Platform/$(SIL_PROG_NAME)/Smm/Sil$(SIL_PROG_NAME)Smm.inf
